        ...
        {`
          @media print {
            .paginaA5 {
              ...
              height: 148mm; /* Altura da página A4 */
              margin: 0 auto; /* Centraliza o conteúdo na página */
            }
            .imprimir-ordem-de-servico {
              /* Estilos de impressão específicos para o modal */
              width: 100%;
              margin: 0 auto;
            }
          }
      ...
      <table className="border-collapse border w-full border-b border-gray-800">
        <thead className="border-b font-medium dark:border-neutral-500">
          ...
          <tbody className="border-b border-gray-800">
            ...
            <tr>
              <td className="border-b border-gray-800 p-2 text-center">Data de agendamento:</td>
              <td className="border-b border-gray-800 p-2 text-center">{agendamento.dataAgendamento}</td>
            </tr>
            <tr>
